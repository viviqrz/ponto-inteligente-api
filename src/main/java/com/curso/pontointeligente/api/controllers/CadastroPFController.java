...
import com.curso.pontointeligente.api.dtos.CadastroPFDto;
...
public class CadastroPFController {
	 ...
	 */
	@PostMapping  //é uma requisição post
	...
	/** 
	 * Verifica se a empresa está cadastrada e se o funcionário não existe na bese de dados
	 * 
	 * @param cadastroPFDto
	 * @param result
	 */
